...
Os links para download estão no [The Comprehensive R Archive Network](https://cran.r-project.org/) (aka CRAN). A versão mais recente é a `4.4.2`, mas pode usar `>= 4.1.x` se já a tiver instalada.
...
[Download R-4.4.2 para MacOX](https://cran.r-project.org/bin/macosx/). Terá de escolher entre a versão *arm64* ou a versão *x86-64*.
