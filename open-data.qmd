...
-   [Bikedata](https://bikedata.cyclestreets.net/) - Compilação de vários dados de mobilidade urbana, incluindo colisões por tipo, contagens de tráfego. Os dados podem ser filtrados e exportados.
